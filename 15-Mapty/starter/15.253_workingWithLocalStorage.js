// Save our workouts on local storage so it is visible on page reloads
// The data stored in local storage can be viewed in local storage menu under browsers application tab.
...
class App {
  ...
  constructor() {
    ...
    // To get already added workouts on page load.
  ...
  _loadMap(position) {
    ...
    // This is line is added here as adding it in getLocalStorage method doesn't work as the map doesn't load initially on reloading the page.
  }
  ...
  _setLocalStorage() {
    ...
    // First param is a key and second param is the workouts object stored as string.
  }

  _getLocalStorage() {
    const data = JSON.parse(localStorage.getItem('Workouts'));
    // JSON.parse is the reverse of stringify method above

    this.#workouts = data;
    // Add the data from local storage to our #workouts array
...
// app.reset(); test this method in console of dev tools
